...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=TRNG6075;Initial Catalog=stockmarket;Persist Security Info=True;User ID=sa;Password=cybage@123456;Trust Server Certificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Stock>(entity =>
        {
            entity.HasKey(e => e.StockId).HasName("PK__Stocks__2C83A9C25CB3FC3B");

            entity.HasIndex(e => e.TickerSymbol, "UQ__Stocks__F144591BFF00CEC6").IsUnique();
        ...
        {
            entity.HasKey(e => e.PriceId).HasName("PK__StockPri__49575BAF2BC2D038");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__Users__1788CC4CA8D44722");

            entity.HasIndex(e => e.Username, "UQ__Users__536C85E448A25879").IsUnique();

            entity.HasIndex(e => e.Email, "UQ__Users__A9D10534338CE758").IsUnique();
        ...
        {
            entity.HasKey(e => e.HoldingId).HasName("PK__UserHold__E524B56DF4A53C5E");
        ...
        {
            entity.HasKey(e => e.TokenId).HasName("PK__UserToke__658FEEEA1545640D");
        ...
        {
            entity.HasKey(e => e.WatchlistId).HasName("PK__Watchlis__48DE55CB36E72881");
